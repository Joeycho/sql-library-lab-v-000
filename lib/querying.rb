...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series INNER JOIN characters on characters.series_id = series.id GROUP BY characters.species ORDER BY count(characters.speices) DESC LIMIT 1"
end
